                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="relative h-[600px] rounded-3xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
                        ...
                        <div className="absolute bottom-8 left-8 text-white">
                            <p className="text-xl font-bold">Building Trust Since 2008</p>
                        </div>
                    </div>

                    <div>
                        <span className="text-amber-500 font-bold tracking-wider uppercase mb-2 block">About Us</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">Building Dreams in Northern Morocco</h2>
